...
function submit(event) {
  ...
  if (validation()) {
    ...
    document.getElementById("rec6").innerHTML = "Total: " + total1; //String Method
  } else {
    console.log("false");
    return;
  }
...
function calculation1() {
  ...
  // let total1 = 0;
  console.log(`Total before Calc: ${total1}`);
  if (WaB) {
    //If statement
    // shirtChoice = Wab.name
    // shirtChoice = document.getElementById("WaB").name;
    ...
    console.log(`Added1: ${total1}`);
    console.log(WaB);
  }
  if (BaF) {
    //If statement
    // shirtChoice = document.getElementById("BaF").name;
